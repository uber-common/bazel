...
public class BuildRequestOptions extends OptionsBase {
  ...
  @Option(
      name = "experimental_action_input_usage_tracker_use_kotlin_jdeps",
      defaultValue = "false",
      documentationCategory = OptionDocumentationCategory.UNDOCUMENTED,
      effectTags = {
              OptionEffectTag.BAZEL_INTERNAL_CONFIGURATION,
      ...
      help = "Whether we should use jdeps data when tracking class usage. Used for incremental rollout.")
  public boolean experimentalActionInputUsageTrackerUseKotlinJdeps;

  @Option(
      name = "experimental_action_input_usage_tracker_use_kotlin_jdeps_for_ksp",
      defaultValue = "false",
      documentationCategory = OptionDocumentationCategory.UNDOCUMENTED,
      effectTags = {
              OptionEffectTag.BAZEL_INTERNAL_CONFIGURATION,
      ...
      help = "Enable KSP compilation avoidance relying on jdeps generated by KotlinCompile actions.")
  public boolean experimentalActionInputUsageTrackerUseKotlinJdepsForKsp;
