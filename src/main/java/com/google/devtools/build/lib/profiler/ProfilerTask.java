...
public enum ProfilerTask {
  ...
  REMOTE_CACHE_CAS_DOWNLOAD("remote cache cas download"),
  REMOTE_CACHE_AC_DOWNLOAD("remote cache ac download"),
  REMOTE_CACHE_CAS_DOWNLOAD_SUCCESS("remote cache cas download success"),
  REMOTE_CACHE_AC_DOWNLOAD_SUCCESS("remote cache ac download success"),
  REMOTE_CACHE_CAS_DOWNLOAD_FAILURE("remote cache cas download failure"),
  REMOTE_CACHE_AC_DOWNLOAD_FAILURE("remote cache ac download failure"),
  REPORTED_STATS("reported stats"),
